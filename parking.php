...
{
	$output = exec('node ./codeminimalpuppeteer.js');
	//echo $output;
	...
	echo '<input id="mySub" type="submit" value="Valider" />';
	echo '</form>';
	echo '<div id="myId">';
	echo '<div>';
...
elseif ($_SESSION['stage'] == 'stage3')
{
	...
	$_SESSION['numero'] = preg_replace( '#\(#','\\\(', $_SESSION['numero'] );
	$_SESSION['modele'] = preg_replace( '#\(#','\\\(', $_SESSION['modele'] );
	$str = 'node ./affichage.js "'.$_SESSION['numero'].'" "'.$_SESSION['modele'].'"  2>&1';	
	//echo 'str : '.$str;
